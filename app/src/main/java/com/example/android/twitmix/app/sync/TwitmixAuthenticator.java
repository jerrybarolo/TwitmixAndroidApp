...
/**
 * Manages "Authentication" to Twitmix's backend service.  The SyncAdapter framework
 ...
 */
public class TwitmixAuthenticator extends AbstractAccountAuthenticator {

    public TwitmixAuthenticator(Context context) {
        super(context);
    }
